...
Future<String> pinFileToIPFS(String pinataApiKey, String pinataSecretApiKey,
    String encryptedFile, String encryptedAESKey) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      return jsonEncode(jsonDecode(response.body)['IpfsHash']).replaceAll('"', '');
    } else {
